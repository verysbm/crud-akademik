    ...
    <div class="col-lg-6">
        ...
        <fieldset>
                ...
                <div class="form-group">
                    ...
                    <input type="hidden" class="form-control" id="id_dosen" name="id_dosen" value="<?php echo $data['nim']?>" readonly>
                </div>
                <div class="form-group">
                    <label for="nama_dosen">Nama Dosen</label>
                    <input type="text" class="form-control" id="nama_dosen" name="nama_dosen" value="<?php echo $data['nama_mhs']?>" placeholder="Nama Dosen">
                </div>
                <div class="form-group">
