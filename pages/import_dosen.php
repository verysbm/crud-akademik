...
<div class="container ">
    <div class="col-lg-6 ">
        <form method="post" action="index.php?page=aksi_import" enctype="multipart/form-data">
            <fieldset>
                <legend>Import Excel</legend>
                <div class="form-group">
                <label>Format Import : </label>
                    <a href="_file/format/Format.xlsx" name="download" class="btn btn-info"><i class="fa fa-download"></i> Download</a>
